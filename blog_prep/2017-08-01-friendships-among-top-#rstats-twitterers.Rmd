...
ggraph(f1, layout='kk') + 
  ...
  labs(title='Top 30 #rstats users and their gender')
...
ggraph(f1, layout='kk') + 
  ...
  labs(title='Top 30 #rstats users and their friends gender')
