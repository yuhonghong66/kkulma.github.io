...
vii) the last but definitely not the least: no number of ticked-off boxes on the to-do list will ever replace relationships. If I have a plan to finish a project in the evening, but then my partner comes home late and we hadn't have a chance to catch up yet, I drop the project and spend the night chatting with him. For some people it's a no-brainer but I had to learn that our closed-ones have no obligation to subordinate to our internal deadlines or projects. They are ultimately the people that 
